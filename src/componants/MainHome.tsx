    ...
    return (
        <>
            <main className='bgMain max-w-full lg:h-auto h-[85vh] text-center flex flex-col justify-center items-center p-4 shadoxHeader'>
                ...
                <h1 className='text-red-600 textStroke px-10 text-2xl lg:pt-13 pb-2 lg:text-4xl'>Le savais-tu ?</h1>
                <h1 className='text-red-600 textStroke px-10 text-2xl pb-10 lg:pb-14 lg:text-4xl'>
                    un Carambar = 1 blague = 1 sourire garanti !
                </h1>

                <h2 className='text-amber-900 h2t-6 px-4 pb-8 lg:text-2xl'>Clique sur le Carambar pour récupérer ton sourire !</h2>
                ...
                <button onClick={getJoke} className='cursor-pointer w-3/5 lg:w-1/5 md:max-w-[300px] lg:hover:scale-110 lg:transition-transform lg:duration-300 pt-10 pb-0 lg:py-10'>
